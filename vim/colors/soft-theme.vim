" Vim color file
" soft-theme
" Created by Nivaldo Neto with ThemeCreator (https://github.com/mswift42/themecreator)
...
let s:bg3="#3b3a42"
let s:bg4="#4e4d54"
let s:keyword="#4594aa"
let s:builtin="#7789b6"
let s:const= "#eb5b27"
let s:comment="#00ffec"
let s:func="#b7797a"
let s:str="#a67da0"
let s:type="#816490"
let s:var="#a5845f"
